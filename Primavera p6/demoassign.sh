...
echo $JAVA_HOME/bin/java -classpath "$INTG_CLASSPATH" $PRIMAVERA_OPTS demo.assignments.AssignmentsDemoApp
"$JAVA_HOME/bin/java" -classpath "$INTG_CLASSPATH" $PRIMAVERA_OPTS demo.assignments.AssignmentsDemoApp
