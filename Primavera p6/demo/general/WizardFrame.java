  ...
  extends JFrame
{
    ...
    private JTextField txtfldRMIHost = new JTextField("localhost\\sqlexpress");
    ...
    private JTextField txtfldProjectId = new JTextField();
    private JTextField txtfldProjectName = new JTextField();
    ...
    private void initComponents()
    {
        ...
        txtfldRMIPort = new JTextField(new LimitedStyledDocument(5, true), "1433", 0);
