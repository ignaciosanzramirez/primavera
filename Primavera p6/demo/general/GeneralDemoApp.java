    ...
    public void runDemo(DemoInfo demoInfo)
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= NUM_ACTIVITIES_TO_ADD; i++)
            {
                ...
                activity.setPlannedDuration(new Duration((double)(i * 3)));
                activity.setRemainingDuration(new Duration((double)(i * 3)));
            }
            ...
            ObjectId[] codeAsgnObjIds = ActivityCodeAssignment.create(session, (ActivityCodeAssignment[])alCodeAssignments.toArray(new ActivityCodeAssignment[alCodeAssignments.size()]));
