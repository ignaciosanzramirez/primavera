...
if [ -r "$INTG_HOME/lib/intgserver.jar" ]; then
    ...
    INTG_CLASSPATH=$INTG_HOME:$INTG_HOME/clientlib/intgclient.jar:$INTG_HOME/lib/commons-lang.jar:$INTG_HOME/lib/wstx-asl-3.1.2.jar
    PRIMAVERA_OPTS=
fi
echo $JAVA_HOME/bin/java -classpath "$INTG_CLASSPATH" $PRIMAVERA_OPTS demo.xmlimport.ImportDemoApp
