...
echo $JAVA_HOME/bin/java -classpath "$INTG_CLASSPATH" $PRIMAVERA_OPTS demo.general.GeneralDemoApp
"$JAVA_HOME/bin/java" -classpath "$INTG_CLASSPATH" $PRIMAVERA_OPTS demo.general.GeneralDemoApp
